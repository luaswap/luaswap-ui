...
import { Arrow, Table, TBody, TD, TextHeader, TFooter, THead, TR, WrapperLoadingTable } from './StakeTableStyled'
      ...
      {isLoadingStakeTable ? (
        ...
        <>
          {tokensLock.length > 0 ? (
            ...
            <WrapperLoadingTable>
              <Text fontSize="16px">You do not have any locked tokens.</Text>
            </WrapperLoadingTable>
          )}
        </>
      )}
